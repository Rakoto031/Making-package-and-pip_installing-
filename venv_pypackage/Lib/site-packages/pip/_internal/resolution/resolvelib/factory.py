...
class Factory:
    ...
    def _make_candidate_from_dist(
        ...
        return self._make_extras_candidate(base, extras) if extras else base
    ...
    def find_candidates(
        ...
        return (
            ...
            else self._iter_found_candidates(
                ireqs,
    ...
    def make_requires_python_requirement(
        ...
        return (
            RequiresPythonRequirement(specifier, self._python_candidate)
            if str(specifier)
            else None
        )
